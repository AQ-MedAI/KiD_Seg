...
nohup python -u test_m3ae_liver.py --datapath ./data/preprocess_nii_256x32 --checkpoint ./output_m3ae_liver/model_best.pth --savepath ./output_m3ae_liver/test_output > <PROJECT_ROOT>/logs/test_m3ae_liver.log 2>&1 &
tail -f <PROJECT_ROOT>/logs/test_m3ae_liver.log
"""
import os
