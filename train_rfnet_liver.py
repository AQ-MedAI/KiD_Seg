...
nohup python -u train_rfnet_liver.py --datapath ./data/preprocess_nii_256x32 --savepath ./output_rfnet_liver > <PROJECT_ROOT>/logs/train_rfnet_liver.log 2>&1 &
tail -f <PROJECT_ROOT>/logs/train_rfnet_liver.log
"""
import os
